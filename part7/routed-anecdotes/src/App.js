...
const CreateNew = (props) => {
  ...
  const inputPropsFromField = (field) => {
    const props = {...field}
    delete props.reset;
    return props;
  }
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
        <div>
          content
          <input name='content' {...inputPropsFromField(content)} />
        </div>
        <div>
          author
          <input name='author' {...inputPropsFromField(author)} />        
        </div>
        <div>
          url for more info
          <input name='info' {...inputPropsFromField(info)} />
        </div>
